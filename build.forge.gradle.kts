...
dependencies {
	...
	compileOnly(annotationProcessor("io.github.llamalad7:mixinextras-common:${prop("mixin_extras_version")}") as Any)
	implementation("jarJar"("io.github.llamalad7:mixinextras-forge:${prop("mixin_extras_version")}") as Any)
}
