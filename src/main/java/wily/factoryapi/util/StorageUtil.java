...
public class StorageUtil {
    ...
    public static void transferFluidTo(IFactoryStorage fromStorage, Function<FluidInstance,FluidInstance> transaction, Direction d, IPlatformFluidHandler fluidFiller){
    ...
    public static void transferFluidFrom(IFactoryStorage toStorage, Function<FluidInstance,FluidInstance> transaction, Direction d, IPlatformFluidHandler fluidDrainer){
