...
public class DynamicUtil {
    ...
    public static ArbitrarySupplier<ItemStack> getItemFromDynamic(Dynamic<?> element, boolean allowData) {
        return element.get("common_item").asString().map(s->COMMON_ITEMS.get(net.minecraft.resources.Identifier.tryParse(s))).result().orElseGet(()-> {
