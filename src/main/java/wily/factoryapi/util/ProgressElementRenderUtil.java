...
public class ProgressElementRenderUtil {
    ...
    public static void renderDefaultProgress(net.minecraft.client.gui.GuiGraphicsExtractor gui, int x, int y, float percentage, IFactoryDrawableType.DrawableProgress type){
    ...
    public static void renderFluidTank(net.minecraft.client.gui.GuiGraphicsExtractor graphics, int x, int y, IFactoryDrawableType type, FluidInstance instance, int capacity, boolean hasColor){
